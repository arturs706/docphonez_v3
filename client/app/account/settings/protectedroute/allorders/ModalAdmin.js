        ...
        <div className={styles.topdiv}>
          ...
          {data.status === "Pending" ? (
                    ...
                    <div className={styles.rightdiv}>
                      <div className={styles.rightdivone}><h4>Order {data.orderid} is getting prepared</h4></div>
                      <div className={styles.rightdivtwo}><h4>The tracking number {data.tracking_number} is in transit</h4></div>
                      <div className={styles.rightdivthree}><h4>Order is on its way to {data.firstline + " " + data.secondline + ", " + data.city + ", " + data.postcode}</h4></div>
                      <div className={styles.rightdivfour}><h4>Current ETA of the delivery is {formatDateTime(data.planned_delivery_time)}</h4></div>
                    </div>
                  </div>
            ...
            <div className={styles.rightdivone}><h4>Order {data.orderid} is getting prepared</h4></div>
              <div className={styles.rightdivtwo}><h4>The tracking number {data.tracking_number} is in transit</h4></div>
              <div className={styles.rightdivthree}><h4>Order is on its way to {data.firstline + " " + data.secondline + ", " + data.city + ", " + data.postcode}</h4></div>
              <div className={styles.rightdivfour}><h4>Order has been delivered at {formatDateTime(data.last_update)}</h4></div>
            </div>
          </div>
          )
          }
